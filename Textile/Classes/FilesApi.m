...
- (NSString *)fileData:(NSString *)hash error:(NSError * _Nullable __autoreleasing *)error {
  NSString *data = [self.node fileData:hash error:error];
  return data;
}

- (NSString *)imageFileDataForMinWidth:(NSString *)path minWidth:(long)minWidth error:(NSError * _Nullable __autoreleasing *)error {
